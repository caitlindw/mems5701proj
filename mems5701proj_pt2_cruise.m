...
ylabel('TSFC');
title('TSFC Values over \pi_{fan} Sweep for Cruise');
...
xlabel('\pi_{fan} Sweep');
ylabel('Isp (s)');
title('Isp Values over \pi_{fan} Sweep for Cruise');
legend('\phi = 1','\phi = 2','\phi = 10');
hold off;
...
xlabel('\pi_{fan} Sweep');
ylabel('Fs (lb)');
title('Specific Thrust Values over \pi_{fan} Sweep for Cruise');
legend('\phi = 1','\phi = 2','\phi = 10');
hold off;
